...
The code for this example is in GitHub [https://github.com/aerospike/query-with-filters](https://github.com/aerospike/query-with-filters).
...
```sql where username = 'bob'```

or range queries on integers:

```sql where age between 25 and 34```
